    		...
    		for(int x=1; x==1;){
    			...
    			for(x=1; x==1;){
					...
					if (choice.equals("1")){
    					...
    					System.out.println("***************************************");
					System.out.println("** 1.)Pondicherry  | 600 |   "+available[1]+"   **");
    					System.out.println("** 2.Bangalore           | 170 |   "+available[2]+"   **");
    					System.out.println("** 3.)chennai            | 150 |   "+available[3]+"   **");
    					System.out.println("** 4.)Vellore            | 200 |   "+available[4]+"   **");
    					System.out.println("** 5.)Erode              | 250 |   "+available[5]+"   **");
    					System.out.println("***************************************");
    					x=0;
					}
					...
					//if CHOICE is "2" proceed to Ticket Booking//
    					...
    					String dest[] = { " ", "Pondichery", "Bangalore", "Chennai", "Vellore", "Erode"};
